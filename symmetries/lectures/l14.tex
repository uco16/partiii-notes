...
\chapter{The Cartan Classification}%
...
\end{align}
with $M(X, Y) \indices{^c_e} = X_a Y_b f \indices{^{ad}_e} f\indices{^{bc}_{d}}$. This is the explicit form of the inner $ad$-map composition.
