...
With the action $S = \int \left[ i \overline{\psi}{}_a \dot{\psi}^a - V(\overline{\psi}{}, \psi) \right] \dd[]{\tau}$, then the Hamiltonian turns out to be $H = V(\overline{\psi}{}, \psi)$. 
