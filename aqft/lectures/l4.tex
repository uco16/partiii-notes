...
First we factor out the vacuum bubble diagrams
\begin{equation}
  [ \dots ] = 
  \underbrace{ [ \
    \begin{gathered}
...
The $2$-point expectation value, which is normalised by $Z(0)$, is then given by those diagrams with two external sources that do not have any vacuum bubbles
\begin{align}
